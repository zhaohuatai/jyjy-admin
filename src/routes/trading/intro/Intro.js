...
import {loadMemberAccountIntroDataSet} from '../../../http';
import DepositFilter from './IntroFilter';
...
class Deposit extends Component {
  ...
  handleActionClick=({item, key})=>{
	...
	onChangePage=(currentPage)=>{
		this.setState({loading:true});
			...
			loadMemberAccountIntroDataSet(searchform, data=>{
				console.log(data);
  ...
  render() {
    ...
    const columns = [
      ...
      { title: '推广收益单号', dataIndex: 'transactionNo', key: 'transactionNo', },
      { title: '收益来源会员', dataIndex: 'fromIntroMemId', key: 'fromIntroMemId',  },
      { title: '第三方交易单号', dataIndex: 'paymentNo', key: 'paymentNo',  },
      { title: '收益金额', dataIndex: 'amount', key: 'amount', },
    ...
    return (
      <div className={style.orderroot}>
			  ...
			  <DepositFilter doSearch={this.doSearch} cleanform={this.doCleanForm} action={this.handleActionClick}/>
        <Table
