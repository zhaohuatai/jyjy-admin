...
import {loadMemberAccountWithdrawDataSet} from '../../../http';
...
class Withdraw extends Component {
  ...
  componentDidMount(){
    loadMemberAccountWithdrawDataSet({
  ...
  handleActionClick=({item, key})=>{
	...
	onChangePage=(currentPage)=>{
		this.setState({loading:true});
			...
			loadMemberAccountWithdrawDataSet(searchform, data=>{
				console.log(data);
  ...
  render() {
    ...
    const columns = [
      ...
      { title: '单号', dataIndex: 'transactionNo', key: 'transactionNo', },
    ...
    return (
      <div className={style.orderroot}>
			  ...
			  <WithdrawFilter doSearch={this.doSearch} cleanform={this.doCleanForm} action={this.handleActionClick}/>
        <Table
