...
import {
  createPubNewsCategory,
  deletePubNewsCategory,
  loadPubNewsCategoryDataSet
} from "../../../service/news";
...
class Category extends Component {
  ...
  doRefresh = (params) => {
    ...
    loadPubNewsCategoryDataSet(params).then(data => {
  ...
  doDelete = (record) => {
    Modal.confirm({
      ...
      okType: 'danger',
      onOk: () => {
        deletePubNewsCategory({id: record.id}).then(data => {
  ...
  doAdd = () => {
    createPubNewsCategory({categoryName: this.props.form.getFieldsValue()['add_categoryName']}).then(data => {
