...
(function () {
  ...
  OssUpload.prototype.init = function (options) {
    ...
    //   return
    // }
    options.object = (options.object ? options.object.replace(new RegExp("^/"), "") : "video/F8D91F2-15FDDCE6715-0006-9EAB-ABE-E40CC.mp4".replace(new RegExp("^/"), ""));
    this._callback = {};
  ...
  OssUpload.prototype.createMultipartUpload = function () {
    var self = this;
    var params = {
      Bucket: (self._config.bucket ? self._config.bucket : f_bucket),
      Key: (self._uploadInfo.object ? self._uploadInfo.object : f_object),
  ...
  VODUpload.prototype = {
    constructor: VODUpload, initialize: function () {
      ...
      f_bucket = curObject.bucket;
      f_object = curObject.object;
